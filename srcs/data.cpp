...
Description: Contains the DATA class, which simulates reading and writing main
memory
*/
...
int Data::readMem(int addr) { return memory.at(addr); }

// Write four bytes to memory starting at <addr>
void Data::writeMem(int addr, int value) { memory.at(addr) = value; }
